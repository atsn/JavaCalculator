...
public class UserInterface implements ActionListener
{
	...
	private void makeFrame()
	{
		...
		displayGrid.add(display);
		displayGrid.add(display2);

		contentPane.add(displayGrid, BorderLayout.NORTH);
	...
	{
		display.setText(calc.getDisplayValue()[0]);
		display2.setText(calc.getDisplayValue()[1]);
	}
